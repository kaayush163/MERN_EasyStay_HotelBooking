...
const HotelReg = () => {
  ...
  const onSubmitHandler = async (event) => {
    try {
      ...
      if (data.success) {
        ...
        setIsOwner(true); //make now the owner true after registeration of hotel done
        setShowHotelReg(false); //hide the hotel registeration form when finally registered for hotel registeration details
      } else {
  ...
  return (
    ...
    // added Onsubmit at 8:01 form handler submit
    <div
      ...
      >
        ...
        <div className="relative flex flex-col items-center md:w-1/2 p-8 md:p-10">
          ...
          <div className="w-full mt-4">
            ...
            {/* after setNamve it will also chnage in value of this input element */}
            <input
